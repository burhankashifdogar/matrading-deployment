...
<div className="w-full flex items-center justify-between py-3.5 gap-4 lg:gap-6 xl:gap-9">          <Link href="/" className="flex items-center gap-3.5 flex-none" aria-label={`${brand.name} home`}>
